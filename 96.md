...
When indicated, `clients` must add a [NIP-98](98.md) `Authorization` header (**optionally** with the encoded `payload_file` tag set to the hex-encoded 256-bit SHA-256 hash of the file).
